  ...
  return (
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content
        ...
        className={cn(
          "fixed left-1/2 top-1/2 z-50 flex w-[calc(100%-1.5rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 flex-col",
      ...
      >
        ...
        <div className="min-h-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden p-6">{children}</div>
      </RadixDialog.Content>
    </RadixDialog.Portal>
  );
}
