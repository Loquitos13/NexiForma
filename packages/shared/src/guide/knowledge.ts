...
export const GUIDE_KNOWLEDGE: GuideKnowledgeEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Para criar uma formação, acede a «Ações de Formação» no menu do Portal e clica em «Nova Ação». Podes definir o curso base, datas, regime (presencial/e-learning), associar formadores, módulos e matricular formandos. Cada ação é o núcleo onde geres turmas, sessões, sumários, presenças e o dossiê pedagógico.",
    related: ["/portal/acoes", "/portal/cursos", "/portal/matriculas", "/portal/progresso-lms"],
  },
  {
    id: "certificados",
